    ...
    public static class Conversation
    {
        ...
        async public static Task<Task> Input(DiscordSocketClient client, SocketUserMessage msg)
        {
            ...
            try
            {
                ...
                else if (message.ToLower().Contains("hi") || message.ToLower().Contains("hello"))
                {
                ...
                else if (message.ToLower().Contains("yes"))
                {
                ...
                else if (message.ToLower().Contains("joke"))
                {
                    ...
                    Response = $"{(Repeat > 0? JokeRepeat[random.Next(JokeRepeat.Count + 1)] : "")}{Responses[random.Next(Responses.Count + 1)]}";
                    // Count should go up per user too
                }

                else if (message.ToLower().Contains("fact"))
                {
                    ...
                    Response = $"{(Repeat > 0 ? FactRepeat[random.Next(FactRepeat.Count + 1)] : "")}{Responses[random.Next(Responses.Count + 1)]}";
                    // Count should go up per user too
                }

                else if (message.ToLower().Contains("story"))
                {
                    ...
                    Response = $"{(Repeat > 0 ? StoryRepeat[random.Next(StoryRepeat.Count + 1)] : "Here's a very short story for you: ")}{Responses[random.Next(Responses.Count + 1)]}";
                    // Count should go up per user too
                }

                else if (message.ToLower().Contains("funny"))
                {
                    Responses = new List<string> { "I thought it was funny.", "It made me laugh." };
                    Response = Responses[random.Next(Responses.Count + 1)];
                }

                else if (message.ToLower().Contains("who made you"))
                {
                ...
                else if (message.ToLower().Contains("you made by"))
                {
                ...
                else if (message.ToLower().Contains("who wrote you"))
                {
